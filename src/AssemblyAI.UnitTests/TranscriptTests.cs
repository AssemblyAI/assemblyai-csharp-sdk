...
public class TranscriptTests
{
    ...
    {
        var transcript = Transcript.FromJson(TranscriptJson);
    ...
    {
        var transcript = Transcript.FromJson(TranscriptJson);
        var json = transcript.ToJsonElement();
        transcript = Transcript.FromJson(json);
        Assert.That(transcript, Is.Not.Null);
        Assert.Multiple(() =>
        {
            Assert.That(transcript.Id, Is.Not.Null);
    ...
    {
        var transcript = Transcript.FromJson(TranscriptJson);
        var json = transcript.ToJsonDocument();
        transcript = Transcript.FromJson(json);
        Assert.That(transcript, Is.Not.Null);
        Assert.Multiple(() =>
        {
    ...
    {
        var transcript = Transcript.FromJson(TranscriptJson);
        var json = transcript.ToJsonNode()!;
        transcript = Transcript.FromJson(json);
        Assert.Multiple(() =>
        {
            Assert.That(transcript.Id, Is.EqualTo(TranscriptId));
